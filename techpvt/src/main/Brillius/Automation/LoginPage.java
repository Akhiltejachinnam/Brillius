...
public class LoginPage {
	...
	@FindBy(how = How.XPATH, using = "//*[@id=\"root\"]/div/div/div[1]/div/img")
	...
	public BrilliusLogPage navigateToPromisesLogPage(WebDriver driver,String testCaseName){
		CommonFunction.clickButton(driver, loginButton, "Login Button");
		BrilliusLogPage pl=PageFactory.initElements(driver,BrilliusLogPage.class);
		return pl;
	}
